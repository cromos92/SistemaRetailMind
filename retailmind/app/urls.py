...
from .views_mercadopago import (
    ...
    api_conciliacion_detectar_retiros_mp,
    api_conciliacion_retiro_detalle_mp,
    api_conciliacion_asignaciones_mp,
    api_conciliacion_retiro_recalcular_mp,
    ...
    gestion_devices_point_mp,
    gestion_modo_device_mp,
    gestion_reasignar_device_mp,
    gestion_maquinas_mp,
    gestion_listar_cajas_mp,
    gestion_asignar_ids_mp,
...
urlpatterns = [
    ...
    path('pos/mercadopago/expirar/<int:transaccion_id>/', expirar_pago_mp, name='mp_expirar_pago'),
    ...
    path('pos/mercadopago/gestion/devices/', gestion_devices_point_mp, name='mp_gestion_devices'),
    path('pos/mercadopago/gestion/devices/modo/', gestion_modo_device_mp, name='mp_gestion_device_modo'),
    path('pos/mercadopago/gestion/devices/reasignar/', gestion_reasignar_device_mp, name='mp_gestion_device_reasignar'),
    path('pos/mercadopago/gestion/maquinas/', gestion_maquinas_mp, name='mp_gestion_maquinas'),
    path('pos/mercadopago/gestion/cajas-mp/', gestion_listar_cajas_mp, name='mp_gestion_listar_cajas'),
    path('pos/mercadopago/gestion/cajas-mp/asignar/', gestion_asignar_ids_mp, name='mp_gestion_asignar_ids'),
